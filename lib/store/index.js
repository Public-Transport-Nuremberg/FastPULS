...
class DB_Store {
    ...
    init = async () => {
        try {
            ...
            const vag_response = await fetch('https://start.vag.de/dm/api/v1/haltestellen.json/vag?name=Plärrer')
            ...
            const vgn_response = await fetch('https://start.vag.de/dm/api/v1/haltestellen.json/vgn?name=Plärrer')
